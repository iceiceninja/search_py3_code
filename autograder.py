...
def loadModuleFile(moduleName, filePath):
    spec = importlib.util.spec_from_file_location(moduleName, filePath)  # Get module spec
    module = importlib.util.module_from_spec(spec)  # Create a module object
    spec.loader.exec_module(module)  # Execute the module in its namespace
    sys.modules[moduleName] = module  # Optionally add the module to sys.modules
    return module
